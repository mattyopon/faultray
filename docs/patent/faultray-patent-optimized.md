...
- (d) constraining the simulation results of step (b) by said per-layer ceilings of step (c), wherein a simulation-predicted availability exceeding any layer ceiling triggers an indication that the result is exceeding the computed availability ceiling and identifies the binding constraint layer;
