...
MESSAGES: dict[str, dict[str, str]] = {
    "en": {
        ...
        # Console report (reporter/report.py)
        "infrastructure_overview": "Infrastructure Overview",
        "metric": "Metric",
        "value": "Value",
        "components": "Components",
        "dependencies": "Dependencies",
        "report_title": "FaultRay Chaos Simulation Report",
        "scenarios_tested": "Scenarios tested",
        "critical": "Critical",
        "warning": "Warning",
        "passed": "Passed",
        "cascade_path": "Cascade path:",
        "passed_with_low_risk": "{count} scenarios passed with low risk",
    },
    "ja": {
        ...
        # Console report (reporter/report.py)
        "infrastructure_overview": "インフラ概要",
        "metric": "項目",
        "value": "値",
        "components": "コンポーネント",
        "dependencies": "依存関係",
        "report_title": "FaultRay カオスシミュレーションレポート",
        "scenarios_tested": "テスト済みシナリオ",
        "critical": "重大",
        "warning": "警告",
        "passed": "合格",
        "cascade_path": "カスケード経路:",
        "passed_with_low_risk": "{count}件のシナリオが低リスクで合格",
    },
}
