...
class PostMortemGenerator:
    ...
    def to_markdown(self, postmortem: PostMortem) -> str:
        ...
        lines.append("---")
        lines.append(
            "*This post-mortem was auto-generated by FaultRay/ChaosProof. "
    ...
    def to_html(self, postmortem: PostMortem) -> str:
        ...
        md = self.to_markdown(postmortem)
        ...
        html_lines.append(
            "<p class='footer'>This post-mortem was auto-generated by FaultRay/ChaosProof. "
    ...
    def _build_sections(self, pm: PostMortem) -> list[PostMortemSection]:
        ...
        return [
            ...
            PostMortemSection(
                ...
                content="\n".join(f"- {l}" for l in pm.lessons_learned),
            ),
        ]
    ...
    def _library_summary_md(self, library: PostMortemLibrary) -> str:
        ...
        lines.append("---")
        lines.append("*Generated by FaultRay/ChaosProof*")
