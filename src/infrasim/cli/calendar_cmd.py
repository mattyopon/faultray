...
def calendar_schedule(
    ...
    """
    from infrasim.simulator.chaos_calendar import ChaosCalendar, ChaosWindow
...
def calendar_forecast(
    ...
    """
    from infrasim.simulator.chaos_calendar import ChaosCalendar
...
def calendar_auto_schedule(
    ...
    """
    from infrasim.scheduler.chaos_calendar import ChaosCalendar, RecurrencePattern
...
def calendar_blackout(
    ...
    from infrasim.scheduler.chaos_calendar import BlackoutWindow, ChaosCalendar
